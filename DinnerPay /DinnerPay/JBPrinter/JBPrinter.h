...
typedef NS_ENUM(NSInteger, JBPrinterStyle) {
    JBPrinterStyleDefault,
    JBPrinterStyleCustom
};

/** 文字对齐方式 */
typedef NS_ENUM(NSInteger, JBTextAlignment) {
    JBTextAlignmentLeft = 0x00,
    JBTextAlignmentCenter = 0x01,
    JBTextAlignmentRight = 0x02
};

/** 字号 */
typedef NS_ENUM(NSInteger, JBFontSize) {
    JBFontSizeTitleSmalle = 0x00,
    JBFontSizeTitleMiddle = 0x11,
    JBFontSizeTitleBig = 0x22
};

@interface JBPrinter : NSObject
